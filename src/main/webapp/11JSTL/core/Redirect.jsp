...
<body>
    ...
    <h4>JSP 내장객체를 통한 페이지 이동</h4>
   	<%
   	/* 그냥 바로 p1자리에 한글로 출판사라고 쓰면 한글깨짐 현상 발생 */
    String p1 = URLEncoder.encode("출판사");
   	String p2 = URLEncoder.encode("골든래빗");
   	
   	//request.getContextPath() : 컨텍스트 루트명을 반환해주는 메서드
   	//response.sendRedirect("/11JSTL/inc/OtherPage.jsp"); /* 404에러 발생함  */
   	response.sendRedirect(request.getContextPath()
   			+"/11JSTL/inc/OtherPage.jsp?user_param1="+p1+"&user_param2="+p2); //sendRedirect 직접적으로 넣어줘야함
   	%>
</body>
</html>