...
try{
	...
	*/
	...
	//기존의 파일명을 새로운 파일명으로 변경한다. File.separator는 '/'를 의미한다. 즉, 경로/파일명을 의미한다.
	File oldFile = new File(saveDirectory + File.separator + fileName); //사과.png
	File newFile = new File(saveDirectory + File.separator + newFileName); //20211201_123456.pngs
	oldFile.renameTo(newFile);
	
	/* 파일을 제외한 나머지 폼값을 받는다. 이때 request객체를 통해 받는 것이
	아니므로 주의해야 한다. 
	
	지금은 MultipartRequest통해 받고 있다.*/
