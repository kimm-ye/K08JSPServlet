...
<body>
	<!--  
		...
		param : 단일값을 받을때 사용한다.
		paramValue : 2개 이상의 값을 받을 때 사용한다. 단 이경우 배열을 
			통해 값을 구분해야 한다.
	-->
	<h3>EL로 폼값 받기</h3>
	<ul>
		...
		<!--  
			...
			EL은 NullPointerException이 발생하지 않으므로 위와 같이 기술해도 문제 없다.
			
			즉, 체크박스에 체크되지 않아도 NullPointerException 이 발생하지 않는다.
		-->
	</ul>
	...
	예외처리를 해야 하므로 EL에 비해서는 불편한 점이 있다.
	*/
	%>
